...
all: test_x86 $(PROGS) afl-fuzz afl-as test_build all_done
...
afl-fuzz:
	$(MAKE) -C bb_metric all
	$(MAKE) -C func_metric all
	$(MAKE) -C loop_metric all
...
clean:
	...
	$(MAKE) -C bb_metric clean
	$(MAKE) -C func_metric clean
	$(MAKE) -C loop_metric clean
